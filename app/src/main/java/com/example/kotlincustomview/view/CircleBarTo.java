...
public class CircleBarTo extends View {
    ...
    public CircleBarTo(Context context) {
        super(context);
        this.context = context;
        init(null, 0);
    }

    public CircleBarTo(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs, 0);
    }

    public CircleBarTo(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setAnimationTime(int time) {
        // 按照比例设置动画执行时间
        anim.setDuration(time * progress / stepnumbermax);
        this.startAnimation(anim);
    }
